...
/** Utility functions used by the sw Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "sw:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load sw specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a sw specific theme is activated (light/dark).*/
    bool swThemeActive();
